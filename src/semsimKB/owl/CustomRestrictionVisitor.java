...
public class CustomRestrictionVisitor extends OWLClassExpressionVisitorAdapter {
	...
	public void visit(OWLObjectSomeValuesFrom desc) {
		...
		Set<String> fillerset = new HashSet<String>(restrictedSomeObjectPropertiesTable.get(desc.getProperty()));
	...
	public void visit(OWLObjectAllValuesFrom desc) {
		Set<String> fillerset = new HashSet<String>(restrictedAllObjectPropertiesTable

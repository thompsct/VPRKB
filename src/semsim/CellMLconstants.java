...
public class CellMLconstants {
	...
	public static Namespace bqbNS = Namespace.getNamespace("bqbiol", SemSimKBConstants.BQB_NAMESPACE);
	public static Namespace rdfNS = Namespace.getNamespace("rdf", SemSimKBConstants.RDF_NAMESPACE);
	public static Namespace dctermsNS = Namespace.getNamespace("dcterms", SemSimKBConstants.DCTERMS_NAMESPACE);
	public static Namespace semsimNS = Namespace.getNamespace("semsim", SemSimKBConstants.SEMSIM_NAMESPACE);
	public static Set<String> CellML_UNIT_DICTIONARY;
	
	public static URI CELLML_CONTAINS_URI = URI.create(SemSimKBConstants.SEMSIM_NAMESPACE + "cellMLcontains");

...
import semsimKB.model.physical.PropertyType;
...
public class D3 {
	...
	public D3(KnowledgeBase semSimModel)
	{
	 ...
	 * @return json
	 */
	private String toJson(KnowledgeBase semSimModel) {
		...
		// the d3 graph
		for(DBPhysicalComponent dataStructure : semSimModel.getKBPhysicalModelComponents()){
	...
	private class Node {
		...
		public Node(String name, int nodeIndex)
		{
			this.name = name;
	...
	private class Graph {
		...
		private transient Map<String, Node> _nodeCache = new Hashtable<String, Node>();
		 ...
		 */
		private Node EnsureNodeAdded(DBPhysicalComponent dataStructure) {

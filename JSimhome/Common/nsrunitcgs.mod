// Common NSR unit library for CGS; last revised Mar 2011
// This defines the same units as nsrunit.mod, 
//   but implements CGS-based unit-compatibility
...
unit
	...
	// electric current
	// note: in CGS, all electrical units are derived units
	// definition here is from Geigy Scientific Tables 1981 v. 1 p 28 
	statamp = cm^(1.5)*g^(.5)/s^2,
	amp = 2.99792458e9 statamp,
	A = amp prefixable,
	mA = 1/1000 amp,
	uA = 1e-6 amp,
